\chapter{Complements}
\label{cocycles}
% In this chapter we explain the relation between $1$-cocycles and complements. The main result is the theorem of Schur-Zassenhaus. Finally we show the correspondence between bijective $1$-cocycles and skew braces.
...
\index{Semidirect product!of groups}
...
By Feit--Thompson's theorem (Theorem \ref{thm:FeitThompson}) , we do not need to assume that
