...
factorizations of groups and and skew braces. 
...
\begin{theorem}[It\^o]
	...
	Let $G=AB$ be a factorization of $G$ through abelian subgroups $A$ and $B$. 
...
A skew brace $A$ is said to be \emph{meta-trivial} if $A^{(2)}$ is a trivial brace. 
\end{definition}
