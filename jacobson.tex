...
% In this chapter we develop the basic definitions and results in non-commutative ring theory related with the Jacobson radical.
...
\textcolor{red}{
\begin{definition}\index{Direct sum of submodules}
...
\index{Nilradical!lower}
\index{Baer--McCoy radical}
\index{Prime radical}
\index{Ring!semiprime}
Let $\mathcal{C}=\{ P : P$ prime ideal of $R\}$. Define
\[
...
\label{Teorema 1.4.3}
\index{Wedderburn--Artin's theorem}
...
\begin{theorem}[Wedderburn-Artin's theorem]
\index{Wedderburn-Artin's theorem}
...
\index{Ring!right Noetherian}
\index{Ring!left Noetherian}
...
\begin{theorem}[Hopkins' theorem]
\index{Hopkins' theorem}
